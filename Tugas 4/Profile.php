...
<body>
				...
				<nav class="navbar navbar-default">
					<div class="container">
						<div class="navbar-header">
							<button type="button" class="navbar-toggle nav-sideButton" data-toggle="collapse" data-tarREQUEST="#myNavbar">
		...
		<img src="Assets/profile_picture.png" style="width: 20%;border-radius: 25%; padding: 2%; float: left;">
...
<section id="contact-us">
		<div class="container">
			...
			<div class="col-lg-4 col md-4 col-sm-12 col-xs-12 contact-REQUESTin-touch">
				<h3>Temukan Kami</h3>
